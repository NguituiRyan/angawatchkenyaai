...
UI = {
    ...
    "advice": {"en": "Crop advice: {diagnosis}. Do: {action}. ({priority}) Confirm with your officer.",
               "sw": "Ushauri: {diagnosis}. Fanya: {action}. ({priority}) Thibitisha na afisa wako."},
    ...
    "help": {"en": "Angawatch: text STATUS, ADVICE, ALERTS, SW/EN, or STOP.",
             "sw": "Angawatch: andika STATUS (HALI), ADVICE (USHAURI), ALERTS, SW/EN, au STOP."},
